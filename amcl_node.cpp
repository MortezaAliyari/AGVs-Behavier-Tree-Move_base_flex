...
class AmclNode
{
  public:
    ...
    //////////////////////Morteza 2022/08/27////////////////////////
    void Nav_mapframe_Callback(const std_msgs::StringConstPtr& msg);
        ...
        first_reconfigure_call_(true)
{
  ...
  //////////////////////Morteza 2022/08/27///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  sub  = n.subscribe("Nav_CM", 1000,&AmclNode::Nav_mapframe_Callback,this); //new format of subscribing topic in constructer function of a class
...
void AmclNode::Nav_mapframe_Callback(const std_msgs::StringConstPtr& msg){

        if (msg->data=="ED"){
            Nav_frame=0;//active Gmapping and share the Map frame_id
            ROS_INFO("Disable Navigation [%s] CM: [%f]", msg->data.c_str(),Nav_frame);
            ...
            Nav_frame=1;
            ROS_INFO("Enable Navigation[%s] CM: [%f]", msg->data.c_str(),Nav_frame);
